...
const projects = [
  {
    name: 'Quillminds',
    description:
      'AI powered platform that help terachers and students to teach and learn better.',
    link: { href: 'https://quillminds.com', label: 'quillminds.com' },
    logo: logoQuillminds,
  },
  {
    name: 'PollPebble.com',
    description: 'A survey platform for creating and sharing polls.',
    link: { href: 'https://pollpebble.com', label: 'pollpebble.com' },
    logo: logoPollPebble,
  },
  {
    name: 'Dreampress',
    description: 'A platform for creating stories and novels with AI.',
    link: { href: 'https://dreampress.ai', label: 'dreampress.ai' },
    logo: logoDreampress,
  },
  {
    name: 'Feel',
