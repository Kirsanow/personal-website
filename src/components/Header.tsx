...
function CTAButton() {
  return (
    <Link
      href="/contact"
      className="inline-flex items-center whitespace-nowrap rounded-full bg-teal-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-teal-600 dark:hover:bg-teal-400"
    >
      Let's Enhance Your App
    </Link>
  )
