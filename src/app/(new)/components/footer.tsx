    ...
    <div className="relative overflow-hidden border-t border-zinc-100 bg-white">
      <Container className="relative">
        <div className="relative mx-auto max-w-2xl py-24 sm:py-32 lg:max-w-4xl lg:px-12">
          {/* Decorative elements */}
          <div className="absolute top-0 left-1/2 -z-10 h-[800px] w-[800px] -translate-x-1/2 [mask-image:radial-gradient(closest-side,white,transparent)]">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center rounded-full bg-white px-8 py-3 text-sm font-medium text-indigo-600 ring-1 shadow-xs ring-indigo-200 transition ring-inset hover:bg-zinc-50 hover:ring-indigo-300"
              >
                Join Community
              </Link>
            </div>
        ...
        <Container>
          <div className="flex flex-col items-center gap-8">
            ...
            <p className="text-sm text-zinc-500">
              &copy; 2025 Kirsanov.co. All rights reserved.
            </p>
          </div>
        </Container>
      </div>
